        ...
        <DataViewer response={{ vilkårsvurderinger, vurdering }}>
            {({ vilkårsvurderinger, vurdering }) => {
                const skalViseVurderingsvalg =
                    påklagetVedtakErValgt(vilkårsvurderinger) && alleVilkårOppfylt(vilkårsvurderinger);
                ...
                return (
                    <>
                        {behandlingErRedigerbar && !skalViseVurderingsvalg && (
                            <Alert variant={'error'}>
                                Alle formkrav må være utfylt. Vennligst naviger til formkravfanen for å ta stilling til
                                formkravene.
                            </Alert>
                        )}
                        ...
                        {skalViseRedigeringsmodus &&
                            (behandling.fagsystem !== Fagsystem.EF ? (
                                <VurderingRedigeringsmodusBaks behandling={behandling} vurdering={vurdering} />
                            ) : (
                                <VurderingRedigeringsmodus behandling={behandling} vurdering={vurdering} />
                            ))}
                    </>
                );
            }}
