...
export const Oppfylt: React.FC<Props> = ({ className, height, width }) => (
    <svg
    ...
    >
        ...
        <g fill="none" fillRule="nonzero">
            <path fill="#1C6937" d="M12 0C5.383 0 0 5.384 0 12s5.383 12 12 12c6.616 0 12-5.384 12-12S18.616 0 12 0z" />
            <path
                fill="#FFF"
